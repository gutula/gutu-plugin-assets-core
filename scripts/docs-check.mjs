...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/assets-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-assets-core:");
...
console.log("Documentation check passed for gutu-plugin-assets-core.");
