...
- Package root: `framework/builtin-plugins/assets-core`
- Service layer: `framework/builtin-plugins/assets-core/src/services/main.service.ts`
- Action layer: `framework/builtin-plugins/assets-core/src/actions/default.action.ts`
- Resource layer: `framework/builtin-plugins/assets-core/src/resources/main.resource.ts`
- UI layer: `framework/builtin-plugins/assets-core/src/ui`

## Safe assumptions

- Use `assets-core` as the stable plugin identifier and `@plugins/assets-core` as the package import name.
