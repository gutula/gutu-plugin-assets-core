# Assets Core Business Rules

## Invariants

- The plugin remains authoritative only for the data declared in `assets-core` and its owned resource set.
...
- ERP parity references are tracked against: `Assets`, `Maintenance`.
