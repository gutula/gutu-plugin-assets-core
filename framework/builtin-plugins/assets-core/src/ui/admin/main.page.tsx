...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "Assets Control Room"),
    React.createElement("p", null, "Asset register truth, custody posture, and capitalization or depreciation visibility."),
    React.createElement(
      "p",
      null,
